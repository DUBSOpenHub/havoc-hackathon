...
>
> A CLI-native adversarial AI orchestration pattern designed to stress-test ideas through parallel multi-agent competition and blind adjudication. Two markdown files with zero lines of code.
